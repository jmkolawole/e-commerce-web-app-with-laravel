...
function addToCart(clicked) {
    ...
    $.ajax({
        type:'get',
        url: "http://localhost/alvinsmakeup/public/cart/addItem/"+pro_id,
...
function getProductType(clicked) {
    ...
    $.ajax({
        type:'get',
        url: "http://localhost/alvinsmakeup/public/get-product-type",
        data: {idSize:item},
        success:function (resp) {
...
function loadCartData() {
    $.ajax({
        url:"http://localhost/alvinsmakeup/public/fetch-cart",
        method:"POST",
