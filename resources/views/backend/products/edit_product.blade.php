...
@section('content')
    <form class="form" action="{{route('edit.product',$product->id)}}" method="POST" enctype="multipart/form-data">
        {{csrf_field()}}
        <div class="row">
            <div class="col-md-8">
                <div class="tile">
                    <h3 class="tile-title">{{$product->product_name}}</h3>
                    <div class="tile-body">
                        ...
                        <div class="form-group">
                            <label class="control-label" for="exampleInputAmount"><b>Brand</b></label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="prev_price" name="prev_price" type="text" value="{{$product->prev_price}}">
                                </div>
                            </div>
                        ...
                        <div class="row">
                                ...
                                <div class="animated-checkbox">
                                    <label>
                                        ...
                                        @if($product->stock_status == "yes")
                                               checked="checked"
                                               @endif
                                        ><span class="label-text">Does This Product Have A Type?</span>
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6" id="stock-area">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="stock"  name="stock" type="text" value="{{$product->stock}}">
                                </div>
                            </div>
                    ...
                    <div class="tile-footer"><button class="btn btn-primary" type="submit">Update</button></div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="tile">
                    <div class="tile-body">
                        ...
                        <div class="form-group">
                            <input type="text" name="keywords" id="keywords" class="form-control keywords" value="{{$product->keywords}}">
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <img id="preview" class="img img-responsive img-thumbnail" style="width: 220px!important; height: 229px!important;"
                                     src="{{asset('images/backend/products/small/'.$product->image)}}" alt="your image"/>
                        ...
                        <div class="animated-checkbox">
                            <label>
                                <input type="checkbox" name="status" @if($product->status == 1) checked="checked" @endif><span class="label-text">Enable</span>
                            </label>
                        </div>
                        ...
                        <div class="animated-checkbox">
                            <label>
                                <input type="checkbox" name="featured" @if($product->featured == 1) checked="checked" @endif><span class="label-text">Enable</span>
                            </label>
                        </div>
