...
@section('breadcrumbs')
    {!! Breadcrumbs::render('edit.coupon',$couponDetails) !!}
@endsection


<form class="form-horizontal" name="add_product" method="POST" action="{{route('edit.coupon',$couponDetails->id)}}">
    {!! csrf_field() !!}
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="coupon_code" name="coupon_code" value="{{$couponDetails->coupon_code}}" minlength="5"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12">
                            <input type="date" class="form-control" id="expiry_date" value="{{$couponDetails->expiry_date}}" name="expiry_date" autocomplete="off">
                        </div>
                    </div>
                ...
                <div class="border-top">
                    <div class="card-body">
                        <button type="submit" class="btn btn-secondary">Edit Coupon</button>
                    </div>
                </div>
            </div>
        </div>
