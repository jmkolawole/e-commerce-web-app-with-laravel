...
@section('icon','fa fa-pencil')
@section('page_title','Edit Testimony')
@section('breadcrumbs')
    {!! Breadcrumbs::render('edit.testimony',$testimony) !!}
@endsection
    ...
    <div class="tile">
        <div class="tile-body">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('edit.testimony',$testimony->id)}}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
