            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#f4f4f4">
                <tr>
                    <td align="center" valign="top">
                        <table width="650" border="0" cellspacing="0" cellpadding="0" class="mobile-shell">
                            <tr>
                                <td class="img-center" style="padding: 45px 15px; font-size:0pt; line-height:0pt; text-align:center;"><a href="#" target="_blank"><img src="{{asset('images/backend/logo4.png')}}" width="225" height="50" border="0" alt="" /></a></td>
                            </tr>
                        </table>
                    </td>
                </tr>
                                    ...
                                    <table width="650" border="0" cellspacing="0" cellpadding="0" class="mobile-shell">
                                        <tr>
                                            <td>
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td class="fluid-img" style="padding-bottom: 40px; font-size:0pt; line-height:0pt; text-align:left;"><a href="#" target="_blank"><img src="{{asset('images/backend/products/large/'.$product->image)}}" width="650" height="487" border="0" alt="" /></a></td>
                                                    </tr>
                                                    <tr>
                                                                        ...
                                                                        <table border="0" cellspacing="0" cellpadding="0">
                                                                            <tr>
                                                                                <td class="text-btn-large" bgcolor="#ffffff" style="color:#4a4a4a; font-family:'Poppins', Arial,sans-serif; font-size:14px; line-height:18px; text-align:center; border:1px solid #e5e5e5; padding:15px 35px;">
                                                                                    <a href="#" target="_blank" class="link-2" style="color:#4a4a4a; text-decoration:none;"><span class="link-2" style="color:#4a4a4a; text-decoration:none;">CHECK US OUT NOW</span></a>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                        <!-- END Button -->
                                                ...
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td class="h3 fw-medium" style="padding-bottom: 20px; color:#4a4a4a; font-family:'Poppins', Arial,sans-serif; font-size:22px; line-height:26px; text-align:center; font-weight:500;">
                                                            New Products From Alvinsmakeup
                                                        </td>
                                                    </tr>
                                                </table>
                                                <!-- END Section Title -->
                                                                                            ...
                                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                <tr>
                                                                                                    <td class="plr-15" style="padding: 50px 15px;">
                                                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                            <tr>
                                                                                                                <td class="fluid-img centered" style="padding-bottom: 25px; font-size:0pt; line-height:0pt; text-align:center;"><a href="#" target="_blank"><img src="{{asset('images/backend/products/medium/'.$product->image)}}" width="260" height="100" border="0" alt="" /></a></td>
                                                                                                            </tr>
                                                                                                            <tr>
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                <td class="h4-2 fw-semibold" style="padding-bottom: 20px; color:#979797; font-family:'Poppins', Arial,sans-serif; font-size:20px; line-height:24px; text-align:center; font-weight:600;">
                                                                                                                    <strike>@if(!empty($product->prev_price))₦{{$product->prev_price}}@endif</strike> &nbsp;
                                                                                                                    <span class="link" style="color:#66b7f0; text-decoration:none;">₦{{$product->price}}</span>
                                                                                                                </td>
                                                                                                            </tr>
                                                                                                            <tr>
                                                                                                                <td align="center">
