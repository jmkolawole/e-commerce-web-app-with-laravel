...
<script src="{{asset('js/frontend/js/jquery.countdown.min.js')}}"></script>


<script src="{{asset('js/frontend/js/jquery.meanmenu.min.js')}}"></script>

<script src="{{asset('js/frontend/js/jquery.scrollUp.js')}}"></script>


<script src="{{asset('js/frontend/js/jquery.fancybox.min.js')}}"></script>


<script src="{{asset('js/frontend/js/jquery-ui.min.js')}}"></script>
