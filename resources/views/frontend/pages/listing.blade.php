...
@section('title',$category->name . ' | '.$niche->name.' | Alvins Makeup')
@if($category->description != "")
    @section('description', truncate($category->description, 150))
@endif
@if($category->keywords != "")
    @section('keywords', truncate($category->keywords, 150))
@endif

@section('og_title',$category->name . ' | '.$niche->name.' | Alvins Makeup')
@section('og_url',url('/products/category/'.$category->url))
@section('og_description',truncate($category->description, 60))
<?php
$image = \App\Product::where('category_id',$category->id)->latest()->first();
?>
    ...
    <div class="breadcrumb-area">
        <div class="container">
            <ol class="breadcrumb breadcrumb-list">
                ...
                <li class="breadcrumb-item"><a href="{{route('niche',$niche->url)}}">{{$niche->name}}</a></li>
