...
@section('title', 'All Products | Alvins Makeup')
...
@section('og_title','All Products | Alvins Makeup')
                                    ...
                                    <div class="thubnail-desc fix">
                                        ...
                                        <div class="pro-thumb-price mt-10">
                                            <p class="d-flex align-items-center"><span class="prev-price">
                                                        ...
                                                        class="price" style="position: relative!important;top:-5px!important;">₦{{$product->price}}</span>
                                            </p>
                                        </div>
                                        <hr>
