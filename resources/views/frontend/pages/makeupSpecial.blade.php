...
@section('title', 'Alvins MakeupSpecial | Alvins Makeup')
@section('description', 'Alvins Makeup Is Your Number 1 Source Of Quality Yet Pocket-Friendly And Beauty Products From Popular
Brands Such As Milani, Tara, Revlon, Mary')
@section('keywords', 'Alvins Makeup Nigeria: Buy Makeup, Cosmetics And Skincare')

@section('og_title','Alvins MakeUpSpecial | Alvins Makeup')
@section('og_url',url('/makeupSpecial'))
@section('og_description','Alvins Makeup Is Your Number 1 Source Of Quality Products')
<?php
$image = \App\Product::where('featured',1)->latest()->first();
?>
    ...
    <div class="breadcrumb-area">
        <div class="container">
            <ol class="breadcrumb breadcrumb-list">
                ...
                <li class="breadcrumb-item active">Alvins MakeupSpecial</li>
                ...
                <div class="col-lg-9 order-1 order-lg-2">
                    ...
                    <div
                        ...
                        <div class="grid-list-view d-flex align-items-center  mb-sm-15">
                            ...
                            <span class="show-items">There are {{$products->total()}} products in this selection.</span>
                        </div>
