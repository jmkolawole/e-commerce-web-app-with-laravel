    ...
    <div class="breadcrumb-area">
        <div class="container">
            <ol class="breadcrumb breadcrumb-list">
                ...
                <li class="breadcrumb-item active">{{$search_product}}</li>
                ...
                <div class="col-lg-12 col-md-12">
                    ...
                    <div
                        ...
                        <div class="grid-list-view d-flex align-items-center  mb-sm-15">
                            ...
                            <span class="show-items">{{$products->total()}} result found</span>
                        </div>
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-6 col-6">
                                            ...
                                            <div class="single-makal-product">
                                                ...
                                                <div class="pro-content">
                                                    <h4 class="pro-title">
                                                        <a href="{{route('product',$product->url)}}">{!! str_replace(ucwords($prod),$text,$product['product_name'])!!}</a>
                                                    </h4>
                                                    <p>
        ...
        $.ajax({
            ...
            success:function (resp) {
                ...
                if(stock == 0){
                    ...
                    $("#in-stock"+clicked).show().text("In Stock").css("font-weight","bold");
