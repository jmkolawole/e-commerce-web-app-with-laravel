...
@section('title',$niche->name .' | Alvins Makeup')
@if($niche->description != "")
    @section('description', truncate($niche->description, 150))
@endif
@if($niche->keywords != "")
    @section('keywords', truncate($niche->keywords, 150))
@endif

@section('og_title',$niche->name .' | Alvins Makeup')
@section('og_url',url('products/niche/'.$niche->url))
@section('og_description',truncate($niche->description, 60))
<?php
$image = \App\Product::where('niche_id',$niche->id)->latest()->first();
?>
                                    ...
                                    <div class="single-makal-product" data-price = "{{$product}}">
                                        ...
                                        <div class="pro-content">
                                            ...
                                            <p><span class="price">₦{{$product->price}}</span><span class="prev-price">
                                                    @if($product->prev_price != 0)₦{{$product->prev_price}}@endif
                                                </span>
                                            </p>
